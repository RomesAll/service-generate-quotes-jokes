__all__ = ('QuotesSchemaPOST', 'QuotesSchemaGET', 'QuotesSchemaPUT',
           ...
           'UsersSchemaGET', 'UsersSchemaPOST', 'UsersSchemaPUT', 'SearchJokesSchema', 'PaginationJokesSchema', 'CredentialsUserSchema')
...
from .base import SearchJokesSchema, PaginationJokesSchema, CredentialsUserSchema